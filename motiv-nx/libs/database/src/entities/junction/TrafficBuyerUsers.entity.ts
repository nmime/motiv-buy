...
// Junction table for M:N relationship between TrafficBuyer and TrafficUsers
// One buyer can view many traffic_users (through campaigns)
// One traffic_user might be visible to multiple buyers (if participating in different campaigns)
