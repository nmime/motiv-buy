...
ssh -o StrictHostKeyChecking=yes \
  ...
  "${VPS_USER}@${VPS_HOST}" \
  bash -c "
    export NODE_ENV='$(get_config NODE_ENV)'
    export PROJECT_NAME='motiv-buy'
    export ENV='$ENVIRONMENT'
    export VPS_DEPLOY_PATH='${VPS_DEPLOY_PATH}'
    export DOCKER_REGISTRY='${DOCKER_REGISTRY}'
    export DOCKER_IMAGE_PREFIX='${DOCKER_IMAGE_PREFIX}'
    export IMAGE_TAG='$(get_config IMAGE_TAG)'
    export PORT='3000'
    export DB_NAME='${DB_NAME}'
    export DB_USER='${DB_USER}'
    export DB_PASSWORD='${DB_PASSWORD}'
    export REDIS_MODE='${REDIS_MODE}'
    export REDIS_HOSTS='${REDIS_HOSTS}'
    export REDIS_PASSWORD='${REDIS_PASSWORD}'
    export JWT_SECRET='${JWT_SECRET}'
    export JWT_EXPIRES_IN='7d'
    export TELEGRAM_BOT_TOKEN='${TELEGRAM_BOT_TOKEN}'
    export CRYPTO_BOT_API_TOKEN='${CRYPTO_BOT_API_TOKEN}'
    export LOG_LEVEL='$(get_config LOG_LEVEL)'
    export RATE_LIMIT_MAX='100'
    export RATE_LIMIT_WINDOW='900000'
    export API_DOMAIN='$(get_config API_DOMAIN)'
    export BOT_DOMAIN='$(get_config BOT_DOMAIN)'
    export MAIN_DOMAIN='$(get_config MAIN_DOMAIN)'
    export LETSENCRYPT_EMAIL='${LETSENCRYPT_EMAIL}'
    export API_PORT_EXTERNAL='3001'
    export DB_PORT_EXTERNAL='5433'
    export REDIS_PORT_EXTERNAL='6381'
    export NATS_PORT_EXTERNAL='4223'
    export NATS_MONITOR_PORT='8223'
    export HTTP_PORT='80'
