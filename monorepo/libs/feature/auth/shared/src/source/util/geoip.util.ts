...
const continentCountryCodesMapping: Record<Continent, CountryCode[]> = {
  [Continent.Africa]: [
    CountryCode.Dz, CountryCode.Ao, CountryCode.Bj, CountryCode.Bw, CountryCode.Bf,
    CountryCode.Bi, CountryCode.Cv, CountryCode.Cm, CountryCode.Cf, CountryCode.Td,
    CountryCode.Km, CountryCode.Cg, CountryCode.Cd, CountryCode.Dj, CountryCode.Eg,
    CountryCode.Gq, CountryCode.Er, CountryCode.Sz, CountryCode.Et, CountryCode.Ga,
    CountryCode.Gm, CountryCode.Gh, CountryCode.Gn, CountryCode.Gw, CountryCode.Ci,
    CountryCode.Ke, CountryCode.Ls, CountryCode.Lr, CountryCode.Ly, CountryCode.Mg,
    CountryCode.Mw, CountryCode.Ml, CountryCode.Mr, CountryCode.Mu, CountryCode.Ma,
    CountryCode.Mz, CountryCode.Na, CountryCode.Ne, CountryCode.Ng, CountryCode.Rw,
    CountryCode.St, CountryCode.Sn, CountryCode.Sc, CountryCode.Sl, CountryCode.So,
    CountryCode.Za, CountryCode.Ss, CountryCode.Sd, CountryCode.Tz, CountryCode.Tg,
    CountryCode.Tn, CountryCode.Ug, CountryCode.Zm, CountryCode.Zw, CountryCode.Yt,
    CountryCode.Re, CountryCode.Eh, CountryCode.Sh, CountryCode.Io,
  ],
  [Continent.Asia]: [
    CountryCode.Af, CountryCode.Am, CountryCode.Az, CountryCode.Bh, CountryCode.Bd,
    CountryCode.Bt, CountryCode.Bn, CountryCode.Mm, CountryCode.Kh, CountryCode.Cn,
    CountryCode.Cy, CountryCode.Ge, CountryCode.In, CountryCode.Id, CountryCode.Ir,
    CountryCode.Iq, CountryCode.Il, CountryCode.Jp, CountryCode.Jo, CountryCode.Kz,
    CountryCode.Kw, CountryCode.Kg, CountryCode.La, CountryCode.Lb, CountryCode.My,
    CountryCode.Mv, CountryCode.Mn, CountryCode.Np, CountryCode.Kp, CountryCode.Kr,
    CountryCode.Om, CountryCode.Pk, CountryCode.Ps, CountryCode.Ph, CountryCode.Qa,
    CountryCode.Sa, CountryCode.Sg, CountryCode.Lk, CountryCode.Sy, CountryCode.Tw,
    CountryCode.Tj, CountryCode.Th, CountryCode.Tr, CountryCode.Tm, CountryCode.Ae,
    CountryCode.Uz, CountryCode.Vn, CountryCode.Ye, CountryCode.Hk, CountryCode.Mo,
    CountryCode.Tl,
  ],
  [Continent.Europe]: [
    CountryCode.Al, CountryCode.Ad, CountryCode.At, CountryCode.By, CountryCode.Be,
    CountryCode.Ba, CountryCode.Bg, CountryCode.Hr, CountryCode.Cz, CountryCode.Dk,
    CountryCode.Ee, CountryCode.Fi, CountryCode.Fr, CountryCode.De, CountryCode.Gr,
    CountryCode.Hu, CountryCode.Is, CountryCode.Ie, CountryCode.It, CountryCode.Lv,
    CountryCode.Li, CountryCode.Lt, CountryCode.Lu, CountryCode.Mt, CountryCode.Md,
    CountryCode.Mc, CountryCode.Me, CountryCode.Nl, CountryCode.Mk, CountryCode.No,
    CountryCode.Pl, CountryCode.Pt, CountryCode.Ro, CountryCode.Ru, CountryCode.Sm,
    CountryCode.Rs, CountryCode.Sk, CountryCode.Si, CountryCode.Es, CountryCode.Se,
    CountryCode.Ch, CountryCode.Ua, CountryCode.Gb, CountryCode.Va, CountryCode.Ax,
    CountryCode.Gi, CountryCode.Gg, CountryCode.Im, CountryCode.Je, CountryCode.Fo,
    CountryCode.Sj,
  ],
  [Continent.NorthAmerica]: [
    CountryCode.Ag, CountryCode.Bs, CountryCode.Bb, CountryCode.Bz, CountryCode.Ca,
    CountryCode.Cr, CountryCode.Cu, CountryCode.Dm, CountryCode.Do, CountryCode.Sv,
    CountryCode.Gd, CountryCode.Gt, CountryCode.Ht, CountryCode.Hn, CountryCode.Jm,
    CountryCode.Mx, CountryCode.Ni, CountryCode.Pa, CountryCode.Kn, CountryCode.Lc,
    CountryCode.Vc, CountryCode.Tt, CountryCode.Us, CountryCode.Ai, CountryCode.Bm,
    CountryCode.Vg, CountryCode.Ky, CountryCode.Gl, CountryCode.Gp, CountryCode.Mq,
    CountryCode.Ms, CountryCode.Pm, CountryCode.Bl, CountryCode.Mf, CountryCode.Sx,
    CountryCode.Tc, CountryCode.Um, CountryCode.Vi, CountryCode.Pr,
  ],
  [Continent.SouthAmerica]: [
    CountryCode.Ar, CountryCode.Bo, CountryCode.Br, CountryCode.Cl, CountryCode.Co,
    CountryCode.Ec, CountryCode.Gy, CountryCode.Py, CountryCode.Pe, CountryCode.Sr,
    CountryCode.Uy, CountryCode.Ve, CountryCode.Aw, CountryCode.Bq, CountryCode.Cw,
    CountryCode.Fk, CountryCode.Gf, CountryCode.Gs,
  ],
  [Continent.Oceania]: [
    CountryCode.Au, CountryCode.Fj, CountryCode.Ki, CountryCode.Mh, CountryCode.Fm,
    CountryCode.Nr, CountryCode.Nz, CountryCode.Pw, CountryCode.Pg, CountryCode.Ws,
    CountryCode.Sb, CountryCode.To, CountryCode.Tv, CountryCode.Vu, CountryCode.As,
    CountryCode.Ck, CountryCode.Gu, CountryCode.Nc, CountryCode.Nu, CountryCode.Nf,
    CountryCode.Mp, CountryCode.Pf, CountryCode.Pn, CountryCode.Tk, CountryCode.Wf,
    CountryCode.Aq, CountryCode.Bv, CountryCode.Hm, CountryCode.Tf,
  ],
};
