...
export interface IBotFactory {
  ...
  /**
   * Create a bot instance without authentication (for testing/mocking)
   *
   * @param options - Bot instance options
   * @returns Bot instance (will fail on actual API calls)
   */
  ...
  /**
   * Get bot information using getMe
   *
   * @param bot - Bot instance
   * @returns Bot information
   */
  getBotInfo(bot: Bot<BotSessionContext>): Promise<BotInstanceInfo>;
}
