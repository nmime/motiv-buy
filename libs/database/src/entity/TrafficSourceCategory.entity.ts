...
export enum TopicCategory {
  ...
  Adult18Plus = 'adult_18_plus',
  Psychology = 'psychology',
  Chats = 'chats',
  Betting = 'betting',
  CreativityAndDesign = 'creativity_and_design',
  ...
  Video = 'video',
  Trash = 'trash',
  StickersThemes = 'stickers_themes',
  Economics = 'economics',
  Spam = 'spam',
  Dating = 'dating',
  ...
  GaiTrafficPolice = 'gai_traffic_police', // Russian traffic police
  Gambling = 'gambling',
  Folders = 'folders',
}
