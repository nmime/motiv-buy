...
export class MigrationService {
  ...
  async createMigration(name: string, type: string): Promise<string> {
    try {
      // Create timestamp-prefixed migration name following CLAUDE.md patterns
  ...
  async runSeeders(seederClass?: string): Promise<SeederResult> {
    ...
    try {
      // Note: MikroORM doesn't have built-in seeder support
      // This is a placeholder for future seeder implementation
