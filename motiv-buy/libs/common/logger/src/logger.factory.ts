...
// @see https://github.com/iamolegga/nestjs-pino/blob/master/src/LoggerModule.ts#L93
...
function createLoggerMiddlewares(params: object, useExisting = false) {
  ...
  // @ts-expect-error TS(2540) FIXME: Cannot assign to 'root' because it is a read-only ... Remove this comment to see the full error message
    ...
    pinoHttp: {
      ...
      hooks: {
        ...
        logMethod(inputArgs, method, level) {
          ...
          // @ts-expect-error TS(2322) FIXME: Type '{ context: {}; error: SerializedError | unde... Remove this comment to see the full error message
