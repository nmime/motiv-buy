...
export class ProblemResponseTransformer implements NestInterceptor, ExceptionFilter {
  ...
  private handleError(context: HttpArgumentsHost, e: unknown): ProblemExceptionDto<unknown> {
    ...
    // TODO: DEV-1469
    //  Trace ID should be generated at the beginning of the request
    //  and be present in all logs during endpoint invocation
    ...
    // For internal server errors, we can use the same localized text for both title and detail
